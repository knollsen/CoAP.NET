...
namespace WdIoT.Platform.Coap.Log
{
    class CommonLoggingManager : ILogManager
    {
        public ILogger GetLogger(Type type)
        {
            return new CommonLogging(global::Common.Logging.LogManager.GetLogger(type));
        }

        public ILogger GetLogger(String name)
        {
            return new CommonLogging(global::Common.Logging.LogManager.GetLogger(name));
        }
