...
using WdIoT.Platform.Coap.EndPoint.Resources;
using WdIoT.Platform.Coap.Log;
using WdIoT.Platform.Coap.Server.Resources;
using WdIoT.Platform.Coap.Util;
using Resource = WdIoT.Platform.Coap.EndPoint.Resources.Resource;
