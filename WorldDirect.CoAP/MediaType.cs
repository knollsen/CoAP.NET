...
namespace WorldDirect.CoAP
{
    ...
    public class MediaType
    {
        ...
        public const Int32 ApplicationVndOmaLwm2mTlv = 11542;

        public const Int32 ApplicationVndOmaLwm2mJson = 11543;
        ...
        static MediaType()
        {
            ...
            registry.Add(ApplicationVndOmaLwm2mTlv, new string[] { "application/vnd.oma.lwm2m+tlv", "tlv" });
            registry.Add(ApplicationVndOmaLwm2mJson, new string[] { "application/vnd.oma.lwm2m+json", "json" });
        }
        ...
        public static Boolean IsPrintable(Int32 mediaType)
        {
            switch (mediaType)
            {
                ...
                case Undefined:
                case ApplicationVndOmaLwm2mTlv:
                case ApplicationVndOmaLwm2mJson:
                    return true;
                default:
                    return false;
            }
